...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/countdown_flutter/countdown_flutter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_device_locale/flutter_device_locale.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_statusbar_text_color/flutter_statusbar_text_color.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/geoflutterfire/geoflutterfire.framework"
