                  ...
                  Container(
                    ...
                    child: Swiper(
                      ...
                      itemBuilder: (BuildContext context, int index2) {
                        return user.photos.length != null
                            ? Hero(
                                tag: "abc",
                                child: CachedNetworkImage(
                                  imageUrl: user.photos[index2].url,
                                  fit: BoxFit.cover,
...
//                            title: Text(
//                              "${user.firstName}, ${user.editInfo['showMyAge'] != null ? !user.editInfo['showMyAge'] ? user.age : "" : user.age}",
//                              style: TextStyle(
//                                  color: Colors.black,
//                                  fontSize: 25,
